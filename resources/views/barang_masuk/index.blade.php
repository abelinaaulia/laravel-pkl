                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Barang Masuk
                            <a href="{{ route('barang_masuk.create') }}" class="btn btn-primary float-right">Tambah</a>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($barang_masuk as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('barang_masuk.destroy', $data->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf

                                                        <a href="{{ route('barang_masuk.edit', $data->id) }}"
                                                            class="btn btn-success float-right">Edit</a>
                                                        <a href="{{ route('barang_masuk.show', $data->id) }}"
